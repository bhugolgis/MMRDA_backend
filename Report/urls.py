...
urlpatterns = [
    ...
    path('materialManagementQuarterExcelDownload/', materialManagementQuarterExcelDownload.as_view(), name='materialManagementQuarterExcelDownload'),
     ...
     path('TreeMangementReportPackage/<str:packages>',TreeMangementReportPackage.as_view(), name='Tree Management Package'),
     ...
     path('TreeManagementReportQuarterView/<str:quarter>/<int:year>',TreeManagementReportQuarterView.as_view(), name='Tree Management Quarter'),
